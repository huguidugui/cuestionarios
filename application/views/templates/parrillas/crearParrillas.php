          ...
          <div class="row">
                  ...
                  <div class="box-body">
                    <div class="row">
                        <form>
                          ...
                          <div class="col-xs-12 col-md-3 margin-top-boton">
                            <label style="visibility: hidden;">Proyecto</label>
                            <button 
                              class="btn btn-info col-xs-12 col-md-12"
                              v-bind:disabled="!botonDisabledCrearParrilla"
                              v-if="banderaCrearParrilla"
              ...
              <div class="box box-success">
                ...
                <div class="box-body">
                  ...
                  <div class="col-md-offset-3 col-md-6 text-center">
                    <button 
                        class="btn btn-success col-xs-12 col-md-12"
                        type="submit" 
                        name="upload" 
                        v-if="banderaCrearItemParrilla"
            ...
            <div v-if="itemParrilla.id > 0" class="col-md-12">
              <div class="box box-success">
                <div class="box-header with-border">
                  <a 
                    v-bind:href="'<?php echo base_url();?>recordar/pdfParrilla/' + itemParrilla.id"
                    target="_blank"
                    class="btn btn-app"
                      ...
                      <table v-show="ocultarSinElementos" class="table table-bordered">
                        ...
                        <tbody>
                          <tr v-for="item in tablaItemsParrilla" v-bind:class="{'facebook-class':(item.nombre == 'Facebook'), 'twitter-class':(item.nombre == 'Twitter'), 'instagram-class':(item.nombre == 'Instagram'), 'animated zoomOutLeft':(item.id == removeRow) }">
                            ...
                            <td width="50%">
                              <input 
                                    v-if="editMode && item.id == editarFila" 
                                    type="text"
                                    class="form-control" 
                                    v-model="item.texto">
                                <p v-else>
                            ...
                            <td class="text-center">
                              <!--
                                BLOQUE START 
                                Bloque de botones if-else para mostrar/guardar botón -->
                              <button 
                                  v-if="editMode && item.id == editarFila"
                                  class="btn btn-default"
                                  v-on:click="updateRow(item.id, item.texto)"
                                  >
                                  Guardar cambios
                              </button>
                              <button
