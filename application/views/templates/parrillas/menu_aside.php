   ...
   ?>
      <section class="sidebar">
         ...
         <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="<?php if(current_url() == base_url().'parrillas') {echo 'active';}?>">
               <a href="<?php echo base_url();?>parrillas">
            ...
            <li class="<?php if(current_url() == base_url().'parrillas/crearParrillasComponentes') {echo 'active';}?>">
               <a href="<?php echo base_url();?>parrillas/crearParrillasComponentes">
                  <i class="fa fa-id-card-o"></i> 
                  <span>Parrillas Componentes</span>
               </a>
            </li>
         </ul>
      </section>
